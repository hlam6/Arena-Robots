 ...
 *
 * It stores a charge and depletes when the Robot collides with
 * any obstacles in the Arena. It is recharged when the robot
 * collides with the RechargeStation.
 */
class RobotBattery {
 public:
