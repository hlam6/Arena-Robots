 ...
 ******************************************************************************/
 /**
 * @brief Struct containing multiple structs of different types.
 *
 * This struct is used to contain parameters for several types
 * of objects, providing a convenient container to initialize the
 * parameters of different types of objects in one place.
 */
struct arena_params {
